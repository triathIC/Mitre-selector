...
- [ ] If the tactic surface changed: update `MitreTactic` union (`packages/mke-core/src/models/index.ts`) and `TACTIC_ORDER` (`packages/mke-core/src/constants/index.ts`).
